...
public class NaukriCreateAccountFeatureStepDefinition {
	...
	public void user_selects_I_am_proffesional_option() throws Throwable {
		...
		public void user_fills_all_employment_details_and_submit() throws Throwable {
			...
			/*driver.findElement(By.xpath("//*[@id=\"designation_0\"]")).sendKeys("analyst");*/
			
		/*	List<WebElement> salaryMode=driver.findElements(By.xpath("//*[@id=\"employmentDetailForm\"]/div[1]/div[1]/resman-salary/div/div[1]/div/div[1]"));
			salaryMode.get(1).click();
			
			WebElement sal1=driver.findElement(By.xpath("//*[@id=\"employmentDetailForm\"]/div[1]/div[1]/resman-salary/div/div[1]/div/div[2]/div[1]/ul/li/div/label/input"));
			Select select2=new Select(sal1);
			select2.selectByVisibleText("1");
			*/
			
			
			
		//	driver.findElement(By.id("designation_0")).sendKeys("Analyst");
